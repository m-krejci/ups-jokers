 ...
 * ========================= */
    ...
    LOG_DEBUG("  -> Po odpojení: nick='%s', socket_fd=%d, is_connected=%d, disconnect_time=%ld, status=%d\n",
           client->nick, client->socket_fd, client->is_connected, client->disconnect_time, client->status);
